      ...
      $(function() {
        ...
        $("#post_button").click(function(){
            ...
            var comCon = $("#comment_content").val();
              ...
              newblock.innerHTML= '<h5 class="list-group-item-heading"><b><?php echo array_shift(explode('@', get_email())); ?></b><small>      - Just Now</small></h5><p class="list-group-item-text"></p>'+comCon;
             var refid = $("#refid").val();
