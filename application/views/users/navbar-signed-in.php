...
<ul class="nav navbar-nav navbar-right">
    <li class="dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li><?php echo anchor('dashboard/help', '<span class="glyphicon glyphicon-question-sign"></span> Help!') ?></li>
            <li><?php echo anchor('dashboard/about', '<span class="glyphicon glyphicon-info-sign"></span> About') ?></li>
